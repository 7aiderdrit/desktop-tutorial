document.addEventListener("DOMContentLoaded", function() {
    ...
    seimge.addEventListener("click", function(event) {
        ...
        bagImage.src = "Gaming Laptops3.png";
    });
});
